...
@media only screen and (max-width: 600px) {
  body {
	...
	if(isset($_POST['register'])){
        ...
        // $dro = date('Y-m-d');
		$save = "INSERT INTO momxmarebeli (type, name, code, mail, city, addl, addp, phone, tarigi, contact, cmobile) VALUES ('$type', '$name', '$code', '$mail', '$city', '$addl', '$addp', '$phone', '$tarigi', '$contact', '$cmobile')";
		// var_dump($save);
